...
(* OASIS_START *)
(* DO NOT EDIT (digest: bccdb82d08654542cbdfd19079afc5fb) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Types"; "Normal_form"; "Custom_set"];
                      lib_pack = true;
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "R&\026\253\176JT\197\019\236\155\167+gj\136";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
